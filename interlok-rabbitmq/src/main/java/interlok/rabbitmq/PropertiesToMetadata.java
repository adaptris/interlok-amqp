...
public class PropertiesToMetadata implements BasicPropertiesHandler {
   ...
   * <p>
   * Note that standard properties such as {@code BasicProperties#getClusterId()} will always be added with the appropriate key from
   * {@link MetadataConstants}. This allows us to have predictable behaviour around those properties as required.
   * </p>
   *
   */
  @Getter
